<?php
    include_once $_SERVER["DOCUMENT_ROOT"] . '/MNProyecto-main/Views/layoutExterno.php';
    include_once $_SERVER["DOCUMENT_ROOT"] . '/MNProyecto-main/Controllers/homeController.php';
?>
